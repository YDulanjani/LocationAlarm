...
public class  AddLocationActivity extends FragmentActivity implements OnMapReadyCallback {
     ...
     * we just add a marker near Colombo, Sri Lanka.
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng colombo = new LatLng(b.getDouble("latitude"),b.getDouble("longitude"));
        mMap.addMarker(new MarkerOptions().position(colombo).title("Marker in Colombo"));
        mMap.animateCamera(CameraUpdateFactory.newLatLngZoom(colombo,10));
