 ...
 */
public class ReminderAdapter extends ArrayAdapter<Location> {

    Context context;
    int layoutResourceId;
    Location data[] = null;

    public ReminderAdapter(Context context, int layoutResourceId, Location[] data) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(row == null)
        {
            ...
            holder.imgIcon = (Switch) row.findViewById(R.id.imgIcon);
